          ...
          <div>
            <ul className="header-links">
              ...
              <li>
                ...
                />
                {specialMenuOn? <div className="special-menu" onMouseLeave={()=>setSpecialMenuOn(false)}>
                  <div className="special-menu-container">
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 16 12"
                        style={
                          specialStyles.soundOn ? buttonSvg.on : buttonSvg.off
                        }
                      >
                        <path
                          id="check"
                      ...
                      <p
                        className={specialStyles.soundOn ? null : "text-hover"}
                        style={{ cursor: "default", userSelect: "none" }}
                      >
                        ovozni yoqish
                      </p>
                      ...
                      <div className="reverse-shrift">
                        ...
                        >
                          <svg
                            ...
                            style = {(fontSize!==fontSizesRange.defaultFontSize)?{opacity:1,fill:(reverseButtonHover?buttonSvg.on.fill:buttonSvg.off.fill)}:buttonSvg.off}
                          >
                            <path
                              id="Union_8"
                              data-name="Union 8"
              ...
              <li>
                <div
                  className="dropDown"
                  onMouseEnter={() => reverse(dropDownHover, setdropDownHover)}
                  onMouseLeave={() => reverse(dropDownHover, setdropDownHover)}
                >
                  <div
